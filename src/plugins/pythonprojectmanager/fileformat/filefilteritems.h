...
class FileFilterBaseItem : public PythonProjectContentItem {
    Q_OBJECT
...
class PythonFileFilterItem : public FileFilterBaseItem {
    Q_OBJECT

public:
    PythonFileFilterItem(QObject *parent = 0);
};
...
//PYTHON_DECLARE_TYPE(PythonProjectManager::PythonFileFilterItem)
//PYTHON_DECLARE_TYPE(PythonProjectManager::JsFileFilterItem)
//PYTHON_DECLARE_TYPE(PythonProjectManager::ImageFileFilterItem)
//PYTHON_DECLARE_TYPE(PythonProjectManager::CssFileFilterItem)
//PYTHON_DECLARE_TYPE(PythonProjectManager::OtherFileFilterItem)
